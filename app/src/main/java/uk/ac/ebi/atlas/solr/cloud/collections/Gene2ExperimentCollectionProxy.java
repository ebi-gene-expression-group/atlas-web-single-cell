...
public class Gene2ExperimentCollectionProxy extends CollectionProxy<Gene2ExperimentCollectionProxy> {
    ...
    public static final Gene2ExperimentSchemaField BIOENTITY_IDENTIFIER =
            new Gene2ExperimentSchemaField("bioentity_identifier");
    public static final Gene2ExperimentSchemaField EXPERIMENT_ACCESSION =
            new Gene2ExperimentSchemaField("experiment_accession");
