...
public class SingleCellAnalyticsCollectionProxy extends CollectionProxy<SingleCellAnalyticsCollectionProxy> {
    ...
    public static final SingleCellAnalyticsSchemaField ONTOLOGY_ANNOTATION_PARENT_LABELS =
            new SingleCellAnalyticsSchemaField("ontology_annotation_parent_labels_t");
    ...
    public static final SingleCellAnalyticsSchemaField ONTOLOGY_ANNOTATION_SYNONYMS =
            new SingleCellAnalyticsSchemaField("ontology_annotation_synonyms_t");

    public static final SingleCellAnalyticsSchemaField CTW_CELL_TYPE =
            new SingleCellAnalyticsSchemaField("ctw_cell_type");
    public static final SingleCellAnalyticsSchemaField CTW_ORGANISM_PART =
            new SingleCellAnalyticsSchemaField("ctw_organism_part");
    public static final SingleCellAnalyticsSchemaField CTW_ORGANISM =
            new SingleCellAnalyticsSchemaField("ctw_organism");
