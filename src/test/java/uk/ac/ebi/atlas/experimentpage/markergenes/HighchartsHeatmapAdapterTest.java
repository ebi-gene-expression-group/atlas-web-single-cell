...
class HighchartsHeatmapAdapterTest {
    ...
    void markerGeneWithoutSymbolHasGeneIDAsName() {
        ...
        var markerGenes = ImmutableSet.of(
        ...
        var result = subject.getMarkerGeneHeatmapData(ImmutableMap.of("1",markerGenes));
    ...
    void cellTypeMarkerGeneWithoutSymbolHasGeneIDAsName() {
        ...
        var result = subject.getMarkerGeneHeatmapData(ImmutableMap.of("T cell",cellTypeMarkerGenes));
