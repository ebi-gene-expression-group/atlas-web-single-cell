...
class TSnePlotDaoIT {
    ...
    void testClustersForK(String experimentAccession, String method, String variable, int perplexity) {
        assertThat(subject.fetchTSnePlotWithClusters(experimentAccession, method, perplexity, variable))
                .isNotEmpty()
                .doesNotHaveDuplicates()
                .allMatch(tSnePointDto -> tSnePointDto.clusterId() <= Integer.valueOf(variable))
                .extracting("name")
                .isSubsetOf(fetchCellIds(experimentAccession));
    }
